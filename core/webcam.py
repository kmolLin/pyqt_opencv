...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def button_open_camera_click(self):
        if self.timer_camera.isActive() == False:
            ...
            if flag == False:
                msg = QtWidgets.QMessageBox.warning(self, u"Warning", u"Check for the connector",
    ...
    def closeEvent(self, event):
        ...
        msg = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Warning, u"Close", u"Check for close！")
